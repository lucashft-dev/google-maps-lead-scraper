# Ancienne version du scraper
# Version utiliser avant de séparer le code en plusieurs fichiers pour plus de clarté et de maintenabilité
# Fait exactement la même chose que la version actuelle
